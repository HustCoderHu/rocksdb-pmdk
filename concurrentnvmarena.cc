...
ConcurrentNVMArena::ConcurrentNVMArena(size_t block_size, AllocTracker *tracker, size_t huge_page_size)
...
size_t ConcurrentNVMArena::ShardAllocatedAndUnused() const
{
    size_t total = 0;
...
char *ConcurrentNVMArena::AllocateFallback(size_t bytes, bool aligned)
{
...
char *ConcurrentNVMArena::AllocateNewBlock(size_t block_bytes)
{
...
char *ConcurrentNVMArena::Allocate(size_t bytes)
{
...
char *ConcurrentNVMArena::AllocateAligned(size_t bytes, size_t huge_page_size, Logger *logger)
{
...
ConcurrentNVMArena::Shard *ConcurrentNVMArena::Repick()
{
